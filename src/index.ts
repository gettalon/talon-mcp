...
import type { HookEventInput, ChannelPermissionRequest } from "./channel-sdk/index.js";
...
async function main(): Promise<void> {
  ...
  bridge.onPermissionVerdict((requestId: string, behavior: "allow" | "deny") => {
  ...
  bridge.onChatMessage(async (chatId: string, text: string, context?: Record<string, string>) => {
    const meta: Record<string, string> = { chat_id: chatId, user: "browser" };
